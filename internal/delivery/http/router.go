...
func Build(authHandler *handlers.AuthHandler, userHandler *handlers.UserHandler, tokenValidator core.TokenValidator) http.Handler {
	r := chi.NewRouter()
	...
	r.Group(func(priv chi.Router) {
		priv.Use(middleware.AuthN(tokenValidator))
	...
	r.Group(func(admin chi.Router) {
		admin.Use(middleware.AuthN(tokenValidator))
